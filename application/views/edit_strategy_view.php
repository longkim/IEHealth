...
$('document').ready(function(){
	$('form.loginform').on('submit',function(form){
		...
		$.post('<?php echo base_url()."strategy/update/".$tid ;?>',p,function(data){
...
<div id="dialog">
<h1 style="padding-top:5px" class="reg">Edit Strategies</h1>
...
<p>
	...
	?>
	<input type="text" name="oname" value="<?php echo $res->s_name?>" id="oname"/>
	<span class="error oname"></span>
</p>
<p>
	<?php echo form_label('Description:','odesc')?>
	<textarea name="odesc" cols="40" rows="10" id="odesc"><?php echo $res->s_description;?></textarea>
